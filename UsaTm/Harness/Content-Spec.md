...
- 수수료, 제출기한, 시스템 명칭, 공식 폼 이름은 `content/research/us_tm_fact_verification_log.md` 또는 공식 출처와 맞춘다.
- 장별 최소 3개 이상의 실무 섹션(H2)을 유지하고, 가능한 경우 체크리스트나 비교표를 포함한다.
- mature 유지 구간에서는 대형 확장보다 filing basis, specimen, monitoring, enforcement 흐름을 더 빨리 찾게 하는 체크리스트, 비교표, handoff 문장과 claim-map freshness를 우선 보강한다.

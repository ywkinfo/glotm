...
- 현재 `UsaTm`의 운영 메타데이터는 루트 기준 `growth / mature / full QA`이며, 15장 체계와 구조화 claim-map을 기준으로 운영합니다.
- reader utility 정비는 filing basis, specimen, maintenance, TTAB·법원·플랫폼·CBP 집행 흐름을 이어서 찾게 만드는 방향을 우선합니다.

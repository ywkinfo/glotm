...
<!-- OMX:RUNTIME:START -->
<session_context>
**Session:** omx-1774918889851-rpk8r1 | 2026-03-31T01:01:29.897Z

**Codebase Map:**
  src/: main, vite-env.d
  src/app/: App.test, App
  src/content/: intro
  src/products/: china, components.test, components, configuredReader, contentLinks.test, europe, japan, latam, liveShellReaders, mexico
  src/test/: setup
  scripts/: prepare-pages, sync-generated-content
  archive/: App, SidebarNav, ChapterOutline, MarkdownArticle, ReaderActionBar, ReadingProgressBar, chapterMetrics, readingHistory, SearchPanel
  ChaTm/: build-content
  EuTm/: build-content, vite-env.d
  JapTm/: build-content
  LatTm/: build-content, build-master, qa-content
  MexTm/: build-content
  UsaTm/: build-content, vite-env.d
  (root): vite.config

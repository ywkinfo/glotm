...
2026-06-28 owner scorecard review에서 Stage 1 선행작업과 Stage 2 fact-review / metadata flip을 함께 닫았다.
...
- [x] 구조화 claim-map 채택(`UsaTm/content/research/claim-map.json`, 12건, 전 항목 BODY_READY)

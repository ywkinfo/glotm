...
| Root metadata verifiedOn | `2026-09-12` | `src/products/registry.ts` |
| Workspace gate rerun | `2026-04-21` `npm --prefix JapTm run content:prepare` pass (이 레인 마지막 로컬 재현; root verifiedOn은 이후 shared root gate로 2026-09-12 re-stamp) | local rerun + shared root gate |

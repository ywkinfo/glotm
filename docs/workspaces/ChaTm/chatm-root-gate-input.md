...
| verifiedOn | `2026-08-25` | `src/products/registry.ts` |
...
- metadata gate: root authoritative metadata는 이미 `15 chapters / 358 search entries / growth / mature / full / gap 0 / verifiedOn 2026-08-25`로 잠겨 있다.

...
| `EuTm` | validate | beta | claim-map adopted · controlled EU+UK scope 유지 · docs/report/workflow 정합화 |
| `UsaTm` | incubate | beta | verification refresh 완료, standard QA 유지 |
| `JapTm` | incubate | beta | beta 유지, standard QA 유지 |
| `UKTm` | incubate | pilot | verification refresh 완료, smoke QA, draft 공개본 early-track 유지 |

...
- `UsaTm` operating-copy maintenance
  - registry 정본 baseline: `15 chapters / 203 search entries / incubate / beta / standard QA` (verifiedOn 2026-06-02). 2026-06-28 mature 선행작업: 집행 포럼 통합 플레이북(15장) 신설 + claim-map 채택 + full-QA 파이프라인 편입. lifecycle/tier/qa flip은 월 scorecard 리뷰 대상.

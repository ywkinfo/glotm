...
**① `EU-ENF-001` 재확인 시점: 2028년경 → 2026년 10월.** 이 claim의 notes는 EU Customs Reform이 미발효라는
...
3개월(1개월 연장 가능)이 그 통지일부터 도므로 2독 시한은 **2026-12-04**(연장 시 2027-01-04)다.

> **그 3개월은 상한이지 하한이 아니다(2026-09-14 정정).** 이 절은 처음에 `관보 게재는 빨라야 2026-12-04
> 이후`라고 적었는데 틀렸다. 제294조 제7항 (a)는 의회가 **그 기간 안에** 이사회 입장을 승인하면 그 시점에
> 법이 채택된 것으로 본다고 정한다 — 시한까지 기다려야 하는 것이 아니라 그 전에 끝날 수 있다. 3개월은
> 의회가 **늦어도 언제까지** 움직여야 하는가이지 관보가 **빨라야 언제** 나오는가가 아니다. 그래서 재확인을
> 시한까지 미루면 그 사이의 채택·게재를 놓친다. 재확인은 **2026년 10월**에 한 번 두고, 시한(2026-12-04,
> 연장 시 2027-01-04) 직후에 다시 본다.

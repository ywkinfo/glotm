...
- 현재 빌드 기준 산출물은 14개 챕터 / 검색 엔트리 196개입니다.
...
- 현재 포트폴리오 실행 순서상 `ChaTm -> MexTm -> EuTm -> Gateway sync` 정렬 안에서, `EuTm`은 full expansion보다 validate lane 안정화와 high-risk gap 축소를 맡습니다.

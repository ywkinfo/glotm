...
- 현재 `JapTm`의 운영 메타데이터는 루트 기준 `growth / mature / full QA`이며(2026-06-29 승급), 우선순위는 1차출처·claim-map freshness 유지와 filing/examination·consent/maintenance/enforcement reader utility 정합화입니다.
- reader utility 정비는 filing, examination·consent, maintenance, enforcement 흐름을 home / continue reading / search에서 더 빨리 찾고 이어 읽게 만드는 방향을 우선합니다.

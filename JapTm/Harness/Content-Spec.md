...
- mature 유지 구간에서는 대형 확장보다 filing, examination·consent, maintenance, enforcement 흐름을 더 빨리 찾게 하는 체크리스트, 비교표, handoff 문장과 claim-map freshness를 우선 보강한다.
- 현재 공개 포지션은 `mature` growth / `full` QA 유지이므로, 편집 문구가 draft-only 상태나 대형 확장 직전처럼 읽히지 않게 관리한다.

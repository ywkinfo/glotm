# JapTm Fact Verification Log

이 문서는 `master.md`에 넣기 전 재검증이 필요한 민감 정보를 관리한다.
원칙은 단순하다. 구조는 본문에 먼저 쓰고, 수치와 세부 기한은 이 문서에서 확인한 뒤 승격한다.

기준일: 2026-06-29 (mature 승격 re-verification refresh)

| 항목 | 현재 작업 가정 | 검증 상태 | 최종 공개본 반영 규칙 | 1차 출처 |
|---|---|---|---|---|
| 일본 상표 기본 원칙 | 일본은 선출원주의가 핵심이며 출원 전 검색이 중요하다 | 2026-06-29 재확인 | 본문에 반영 가능 | https://www.jpo.go.jp/e/faq/yokuaru/trademark.html |
| 해외 거주자 절차 | 일본 비거주자는 일본 내 대표자 또는 대리인 구조를 먼저 정해야 한다 | 2026-06-29 재확인 | 본문에 반영 가능. 세부 자격 범위는 확장 단정 금지 | https://www.jpo.go.jp/e/system/professionals/step-by-step-trademark.html |
| 존속기간 | 상표권 존속기간은 설정등록일부터 10년이며 갱신 가능하다 | 2026-06-29 재확인 | 본문에 반영 가능 | https://www.jpo.go.jp/e/system/trademark/gaiyo/chizai08.html |
| opposition 시점 | 등록공보 게재 후 2개월 내 opposition이 가능하다 | 2026-06-29 재확인 | 본문에 반영 가능. 체크리스트에 캘린더 항목으로 넣을 수 있음 | https://www.jpo.go.jp/e/faq/yokuaru/trademark.html |
| 출원 수수료 | 상표 출원은 `JPY 3,400 + class당 JPY 8,600` 구조다 | 2026-06-29 재확인 | 본문에는 필요 시 구조만 표기하고, 공개 직전 수치 재확인 | https://www.jpo.go.jp/e/system/process/tesuryo/hyou.html |
| 등록·갱신 수수료 | 등록·갱신은 class별 수수료 구조이며 분할 납부가 가능하다 | 2026-06-29 재확인 | 본문에는 class별 정부수수료 구조로 우선 표기. 금액은 공개 직전 다시 확인 | https://www.jpo.go.jp/e/system/process/tesuryo/hyou.html |
...
- 본문에는 검증 상태가 `확인 필요`인 항목의 정확 숫자, 날짜, 세부 요건을 넣지 않는다.
- `2026-06-29 재확인` 항목도 실제 공개 직전 한 번 더 확인하는 것을 원칙으로 한다.
- 일본어 원문과 영어 안내 페이지가 어긋날 경우, 독자의 행동을 좌우하는 값은 원문 기준으로 재검증한다.

## 2026-06-29 note (mature 승격 re-verification)

- mature 승급을 위한 verification refresh 패스. 모든 항목을 1차 출처 기준으로 재대조하고 기준일을 재스탬프했다.
- 신규 1건: 병존동의제도(consent system, 2023 개정 상표법·2024-04-01 시행) — 기존에는 가속심사 제외 맥락의
  주변 언급뿐이었으나, 본격 항목으로 승격해 제4조 제1항 제11호 거절 극복 경로(동의 + 비혼동 요건)를 본문(Ch3·Ch6)과
  `claim-map.json`(JP-CONSENT-001)에 반영했다.

...
영국 등록은 10년마다 갱신되며, 갱신 수수료는 첫 클래스 £245, 추가 클래스당 £60이다(2026-04-01 UKIPO 개정 기준). 금액 자체보다 중요한 것은 갱신 이벤트를 포트폴리오 정비 이벤트로 쓰는 습관이다.
...
| 추가 클래스 | 클래스당 £60 | 불필요한 범위 유지 여부를 함께 검토 |

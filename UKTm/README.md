...
- 이번 유지보수의 초점은 대형 확장보다 승급 후 공개본의 설명과 reader utility를 안정적으로 유지하는 데 있습니다. 현재 다음 액션은 reader-utility 정합이며, 홈/continue reading/search 문구는 `filing decision board`(제3장), `maintenance owner board`(제7장), `online incident quick board`(제11장) 흐름을 빠르게 다시 찾게 하는 방향을 우선합니다.

...
- 이번 유지보수의 초점은 대형 확장보다 early-track 공개본의 설명과 reader utility를 안정적으로 유지하는 데 있습니다. 현재 다음 액션은 standard-QA prep이며, 홈/continue reading/search 문구는 `early-track filing decision board`, `pilot-lane maintenance owner board`, `online incident quick board` 흐름을 빠르게 다시 찾게 하는 방향을 우선합니다.

...
const reportSource: ReportMeta[] = [
  ...
  },
  {
    ...
    summary:
      "니스 45류는 공통 언어일 뿐, 실제 보호범위는 관할별 심사언어(한국 유사군코드·미국 ID Manual·중국 서브클래스·일본 SGC·EU 명확성)에서 갈립니다. 하나의 마스터 명세를 만들고 시장별로 매핑하되, 과잉 청구는 불사용취소·악의 공격의 표적이 되므로 핵심·인접·보류로 나눠 설계하는 법을 정리한 리포트입니다.",

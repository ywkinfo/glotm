...
const latestBriefIssue: BriefIssue = {
  ...
  title:
    "2026년 7월 Hot Global TM Brief | 정부가 상표권자가 되는 K-브랜드 인증, 8월 70개국 출원 전에 기업이 정리할 것들",
  summary:
    "지식재산처가 해외 위조상품에 대응하는 K-브랜드 정부인증 제도를 도입합니다. 4월 6일 대한민국 정책브리핑에 따르면 정부가 인증상표의 권리자로서 해외에 직접 등록하고, 기업이 사용을 신청하면 정품인증기술을 적용해 위조상품 유통을 실시간으로 파악·대응하는 구조입니다. 서울경제 영문판 3월 31일 보도 기준으로 인증표장을 6월까지 개발하고 8월부터 K-푸드·K-뷰티·K-패션 수출 비중과 위조 위험이 높은 70개국에 출원을 시작하는 일정입니다. 수출기업 입장에서 정부가 권리자인 인증 레이어는 의미 있는 지원 장치이지만, 기업 자신의 상표 포트폴리오·세관 등록·증거 체계를 대체하지는 않습니다. 출원 개시 전인 지금이 자체 권리 공백을 점검할 시점입니다.",
  cadenceLabel: "주간 브리프",
  publishedAt: "2026-07-04T00:00:00.000Z",
  jurisdictions: ["Korea", "Cross-Border Enforcement", "Counterfeit Control", "Certification Mark", "K-Brand"],
  bodyParagraphs: [
    "지식재산처는 4월 6일 대한민국 정책브리핑을 통해 K-브랜드 정부인증 제도의 구조를 밝혔습니다. 정부가 인증상표의 권리자가 되어 해외에 직접 등록하고, 기업이 사용을 신청하면 정품인증기술을 적용하는 방식입니다. 서울경제 영문판 3월 31일 보도에 따르면 인증표장을 6월까지 개발하고, 8월부터 K-푸드·K-뷰티·K-패션 수출 비중과 위조상품 유통 위험이 높은 70개국에 출원을 시작하는 일정입니다.",
    ...
    "다만 이 제도를 기업 자신의 상표 전략의 대체재로 읽으면 곤란합니다. 정부 인증표장은 정부가 권리자인 별도의 표장이고, 기업 고유 브랜드의 상표권과는 다른 레이어입니다. 인증마크가 정품·가품을 걸러 주더라도, 기업 상표 자체의 해외 선점·모용 문제, 주요 수출국 등록 공백, 세관 등록 미비, 자체 사용·유통 증거 부재는 그대로 남습니다. 오히려 정부 레이어가 강해질수록 자기 권리가 비어 있는 기업의 공백이 더 도드라질 수 있습니다.",
    "그래서 8월 출원 개시 전인 지금 점검할 것은 인증제도 자체가 아니라 자기 쪽 준비입니다. 첫째, 주요 수출국에서 자사 핵심 상표의 등록·출원 상태를 국가별로 확인합니다. 둘째, 위조 위험이 큰 시장의 세관 등록(중국 해관 등록, 멕시코·중남미 국경 조치, EU 세관 AFA 신청 등) 여부를 채웁니다. 셋째, 정품 채널과 유통 구조를 증빙 가능한 형태로 정리해 둡니다. 넷째, 인증표장 사용 신청이 열렸을 때 바로 대조할 수 있도록 자사 제품군·수출국 목록을 표 하나로 준비합니다.",
  ...
  items: [
    {
      ...
      headline:
        "정부 인증표장이 생겨도 기업 자신의 상표·세관·증거 체계는 대체되지 않습니다 — 8월 70개국 출원 개시 전에 자체 공백을 점검해야 합니다",
      whatChanged:
        "지식재산처가 4월 6일 정책브리핑에서 K-브랜드 정부인증 제도의 구조를 밝혔습니다. 정부가 인증상표 권리자로서 해외에 직접 등록하고, 기업이 사용을 신청하면 정품인증기술을 적용해 위조상품 유통을 실시간 파악·대응합니다. 서울경제 영문판 3월 31일 보도 기준으로 인증표장을 6월까지 개발하고 8월부터 70개국에 출원을 시작하는 일정이며, QR코드·AI 워터마크로 해외 소비자가 정품을 확인할 수 있습니다.",
      whoShouldCare:

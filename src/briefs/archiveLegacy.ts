...
const kbrandGovernmentCertificationIssue: BriefIssue = {
  ...
  supersededBy: {
    ...
    note: "이 이슈는 K-브랜드 정부인증 제도의 시행이 예고 단계였던 2026년 7월 4일 시점을 기준으로 작성됐습니다. 이후 지식재산처 2026년 8월 24일 보도자료로 1차 참여기업 모집이 2026년 8월 24일부터 9월 11일까지 진행된다는 점, 국가인증상표의 출원·등록 대상국이 73개국이라는 점, 그리고 참여요건으로 국가인증상표를 사용하려는 해외 국가에 기업 자신의 상표가 이미 출원 또는 등록돼 있어야 한다는 점이 확정됐습니다. 확정된 모집 일정과 참여요건, 마감 전 점검 순서는 2026년 8월 31일 이슈에서 다룹니다."
  },

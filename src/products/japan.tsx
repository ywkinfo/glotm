...
const {
  ...
  homeSummary: (
    <>
      ...
      자연스럽습니다. 현재는 대형 확장보다 route, maintenance, evidence hygiene를 빠르게 다시
      확인하는 lighter-track reader utility와 standard QA refresh 유지에 초점을 둡니다.
    </>
  ),
  ...
  positioningNote: (
    <>
      ...
      메모, 유지관리 owner map, evidence hygiene를 반복 검증하며 lighter track을 안정적으로
      유지하되, beta / standard QA 기준에서 이어 읽기와 search handoff가 흔들리지 않게 다듬는 쪽이 우선입니다.
    </>
  ),
  chapterBadge: "Japan",

...
const {
  ...
  homeHeroKicker: "미국 단일국가 beta guide",
  homeSummary: (
    <>
      USPTO 중심의 미국 연방 상표 실무를 beta lighter-track으로 빠르게 점검하기 위한 단일국가
      가이드입니다.
      ...
      specimen, monitoring 흐름을 빠르게 다시 찾는 lighter-track reader utility와 standard QA refresh 유지에 초점을 둡니다.
    </>
  ),
  positioningKicker: "UsaTm Positioning",
  positioningTitle: "미국 연방 실무를 beta lighter-track으로 유지하는 incubate guide",
  positioningNote: (
    <>
      ...
      monitoring triage를 반복 검증하며 beta / standard QA 기준의 lighter track을 안정적으로 유지하는 쪽이 우선입니다.
    </>
  ),
  chapterBadge: "USA",

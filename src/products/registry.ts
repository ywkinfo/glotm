...
export const products: ProductMeta[] = [
  {
    ...
    maturityNote: "flagship 보호 · 2026-08-25 full-lane 재검증 완료",
    coverageType: "region",
  ...
  },
  {
    ...
    lifecycleTone: "mature",
    verifiedOn: "2026-08-25T00:00:00.000Z",
    factsReviewedOn: "2026-07-21T00:00:00.000Z",
    qaLevel: "full",
    highRiskVerificationGapCount: 0,
    audience: "멕시코 진출 직전 판단이 필요한 브랜드 관리자, 인하우스 IP 담당자",
    primaryCtaLabel: "MexTm 먼저 보기",
    maturityNote: "mature 유지 · Sprint 2 운영 handoff 3장 보강 · 2026-08-25 shared root gate 재검증 완료",
  ...
  },
  {
    ...
    lifecycleTone: "mature",
    verifiedOn: "2026-08-25T00:00:00.000Z",
    factsReviewedOn: "2026-08-15T00:00:00.000Z",
    qaLevel: "full",
    highRiskVerificationGapCount: 0,
  ...
  },
  {
    ...
    summary: "UKIPO filing·maintenance·enforcement와 다중 포럼 집행 오케스트레이션을 full QA로 묶은 growth country guide입니다.",
    chapterCount: 15,
    searchEntryCount: 183,
    portfolioTier: "growth",
    lifecycleStatus: "mature",
    lifecycleTone: "mature",
    verifiedOn: "2026-08-25T00:00:00.000Z",
    factsReviewedOn: "2026-07-22T00:00:00.000Z",
    qaLevel: "full",
    highRiskVerificationGapCount: 0,
    audience: "영국 단일 시장 진출과 운영을 준비하는 브랜드 관리자, 인하우스 IP 담당자",
    primaryCtaLabel: "UKTm 보기",
    maturityNote: "mature 승급 · 다중 포럼 집행 오케스트레이션 15장 신설 + 저밀도 장 보강(density 12.2) · claim-map 11건 · UK 수수료 출원 £205/갱신 £245/추가 클래스 £60 정합 · full-QA 파이프라인",
    coverageType: "country",
    availability: "live_shell"
  }
];

...
export const products: ProductMeta[] = [
  ...
  },
  {
    ...
    lifecycleTone: "mature",
    verifiedOn: "2026-09-12T00:00:00.000Z",
    factsReviewedOn: "2026-08-30T00:00:00.000Z",
    qaLevel: "full",
    highRiskVerificationGapCount: 0,
    audience: "멕시코 진출 직전 판단이 필요한 브랜드 관리자, 인하우스 IP 담당자",
    primaryCtaLabel: "MexTm 먼저 보기",
    maturityNote: "mature 유지 · Sprint 2 운영 handoff 3장 보강 · 2026-09-12 shared root gate 재검증 완료",

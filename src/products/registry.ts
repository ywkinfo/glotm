...
export const products: ProductMeta[] = [
  ...
  },
  {
    ...
    chapterCount: 15,
    searchEntryCount: 203,
    portfolioTier: "growth",
    lifecycleStatus: "mature",
    lifecycleTone: "mature",
    verifiedOn: "2026-06-28T00:00:00.000Z",
    factsReviewedOn: "2026-06-28T00:00:00.000Z",
    qaLevel: "full",
    highRiskVerificationGapCount: 0,
    audience: "미국 단일 시장 진출과 운영을 준비하는 브랜드 관리자, 인하우스 IP 담당자",
    primaryCtaLabel: "UsaTm 보기",
    maturityNote: "mature 승급 · 집행 포럼 통합 플레이북 신설 · claim-map 12건 2026-06-28 1차출처 재대조 · full-QA 파이프라인 편입",
    coverageType: "country",
    availability: "live_shell"
  },
  {
